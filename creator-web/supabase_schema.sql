...
-- Seed 6 Home Screen Projects linked to sknye1004@gmail.com
INSERT INTO public.projects (
  id, creator_id, title, service_name, service_desc, category, platform, is_ab_test,
  service_url, duration, target_count, current_count, reward_coin, questions, quizzes
)
VALUES 
  (
    '11111111-1111-1111-1111-111111111111',
    'a1004100-4100-4100-4100-100410041004',
    'AI 기반 하루 일기 웹앱 써보시고 UX 피드백 남겨주세요',
    'AI 일기분석 UI',
    '안녕하세요! AI 기반 감정 분석 일기 웹앱 서비스입니다. 일기를 작성할 때 감정 통계 대시보드가 직관적으로 다가오는지 A/B안 비교 피드백을 남겨주세요.',
    'abtest', 'web', TRUE,
    'https://diary-ai-test.vercel.app', '30초', 30, 18, 5,
    '[{"title": "감정 통계 대시보드 A안과 B안 중 어떤 안이 더 직관적이신가요?"}, {"title": "AI 분석 결과 문구가 유용한가요?"}]'::jsonb,
    '[]'::jsonb
  ),
  (
    '22222222-2222-2222-2222-222222222222',
    'a1004100-4100-4100-4100-100410041004',
    '가계부 앱 베타테스터 모집 - 새로운 디자인 어떠신가요?',
    '머니로그 가계부 v2.1',
    'AI 영수증 인식 스마트 가계부 머니로그입니다. 영수증 사진 촬영으로 자동 지출 분류 가계부 UX를 직접 체험해 보시고 지출 트래킹 UI의 개선점을 남겨주세요.',
    'product', 'app', FALSE,
    'https://moneylog-app.com', '5분', 50, 45, 300,
    '[{"title": "영수증 촬영 자동 인식 속도와 정확도 만족도"}, {"title": "새로운 지출 트래킹 UI에서 개선되었으면 하는 점"}]'::jsonb,
    '[{"question": "머니로그 가계부에서 지출 내역이 자동으로 분류되는 방식은 무엇인가요?", "answer": "영수증 사진 촬영 인식"}]'::jsonb
  ),
  (
    '33333333-3333-3333-3333-333333333333',
    'a1004100-4100-4100-4100-100410041004',
    'SaaS 서비스 랜딩페이지 카피라이팅 선호도 투표',
    'SaaS 랜딩페이지',
    'B2B SaaS 수익 관리 대시보드 랜딩페이지 메인 카피라이팅 선호도 투표입니다. 고객의 흥미를 가장 잘 끄는 문구를 선택해 주세요.',
    'vote', 'web', TRUE,
    'https://saas-copy-vote.com', '1분', 100, 5, 15,
    '[{"title": "헤더 문구 A안: 1분 만에 끝내는 지출 분석 vs B안: 자동 수익 관리 대시보드 중 선호하는 카피는?"}]'::jsonb,
    '[]'::jsonb
  ),
  (
    '44444444-4444-4444-4444-444444444444',
    'a1004100-4100-4100-4100-100410041004',
    '초보자를 위한 가상자산 포트폴리오 대시보드 프로토타입 검증',
    '가상자산 대시보드',
    '초보자를 위한 가상자산 포트폴리오 대시보드 피그마 프로토타입 반응 조사입니다. 복잡한 차트 대신 한눈에 보이는 리스크 지표의 명확성을 평가해 주세요.',
    'prototype', 'web', FALSE,
    'https://figma.com/@crypto/portfolio-prototype', '2분', 40, 28, 50,
    '[{"title": "리스크 지표 시각화 디자인이 자산 파악에 도움이 되나요?"}]'::jsonb,
    '[]'::jsonb
  ),
  (
    '55555555-5555-5555-5555-555555555555',
    'a1004100-4100-4100-4100-100410041004',
    '2030 자취족을 위한 가계 관리 니즈 설문조사 (3분)',
    '자취 생활 패턴 설문',
    '대학생 및 2030 자취족의 고정 지출과 생필품 공동구매 니즈에 관한 간단한 3분 설문조사입니다. 성실히 응답해 주신 분들께 100 동전을 지급합니다.',
    'survey', 'web', FALSE,
    'https://forms.gle/dondwae-survey-2030', '3분', 100, 5, 100,
    '[{"title": "한 달 평균 식비 및 고정 지출 금액은 얼마인가요?"}, {"title": "생필품 공동구매 기능이 있다면 이용할 의향이 있으신가요?"}]'::jsonb,
    '[]'::jsonb
  ),
  (
    '66666666-6666-6666-6666-666666666666',
    'a1004100-4100-4100-4100-100410041004',
    '습관 형성 앱 7일 프로덕트 사용 리포트 및 피드백',
    '해빗락 (HabitLock)',
    '목표 달성 습관 형성 서비스 해빗락 7일간의 사용 리포트 및 UI 사용성 검증입니다. 매일 목표 설정과 푸시 알림의 몰입감을 테스트해 주세요.',
    'product', 'app', FALSE,
    'https://habitlock.app', '10분', 20, 18, 1000,
    '[{"title": "7일간 습관 달성률 그래프가 목표 의식을 고취시켰나요?"}, {"title": "푸시 알림 시간대 설정의 편리성 평가"}]'::jsonb,
    '[]'::jsonb
  )
ON CONFLICT (id) DO NOTHING;
